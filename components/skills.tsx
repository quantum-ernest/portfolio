...
const skillCategories = [
    {
        ...
        skills: ["FastAPI", "Django", "Flask", "Express", "Odoo", "REST", "SOAP", "gRPC", "GraphQL", "PyTorch", "TensorFlow", "HuggingFace"],
...
export default function Skills() {
    ...
    return (
        <section id="skills" className="py-20 relative">
            <div
                className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_center,rgba(var(--primary),0.1),transparent_50%)]"></div>
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        I have experience with a wide range of technologies across different domains of software
                        development.
                    </p>
                </motion.div>
                ...
                >
                    {skillCategories.map((category, index) => (
                        ...
                        >
                            <div
                                className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                                <div className="flex items-center mb-4">
                                    <div
                                        className={`p-3 rounded-md bg-gradient-to-br ${category.color} mr-3 text-white shadow-lg`}>
                                        {category.icon}
                                    </div>
